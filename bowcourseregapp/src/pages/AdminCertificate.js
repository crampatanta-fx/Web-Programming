...
function AdminCertificate() {
  ...
  const [filteredCertificateCourseList, setFilteredCertificateCourseList] =
    useState([]);
  ...
  }, [searchTerm, certificatecourseData]);
      ...
      <div className="my-0">
        <div className="p-5 text-center bg-body-tertiary">
          <div className="container py-5">
            ...
            <Link to="/AdminCertificate" className="btn btn-danger btn-md ms-2">
              Certificate Course
            </Link>
            <Link
              to="/AdminStudentList"
              ...
              <div className="p-1 text-center bg-body-tertiary">
                <div className="container py-1">
                  <h3 className="text-body">
                    Certificate Course Content Management
                  </h3>
                  ...
                  <table>
                    ...
                    <tbody>
                      {filteredCertificateCourseList.length > 0
                        ? filteredCertificateCourseList.map(
                            (certificatecourselist) => (
                              <tr key={certificatecourselist.CourseID}>
                                ...
                                <td>
                                  {certificatecourselist.CourseDescription}
                                </td>
                                ...
                                <td>
                                  <Link
                                    to={`/AdminEditCourse/${certificatecourselist.CourseID}`}
                                ...
                                <td>
                                  <Link
                                    ...
                                    onClick={() =>
                                      deleteCourse(
                                        certificatecourselist.CourseID
                                      )
                                    }
                                  >
                                    DELETE
                            ...
                            <tr key={certificatecourselist.CourseID}>
                              ...
                              <td>
                                <Link
                                  className="btn btn-danger btn-sm ms-2"
                                  onClick={() =>
                                    deleteCourse(certificatecourselist.CourseID)
                                  }
                                >
                                  DELETE
                                </Link>
