...
function StudentPostDiplomaRegister() {
  ...
  // const [selectedTerm, setSelectedTerm] = userState("");
  ...
  const enrollCourse = (courseID) => {
    ...
    fetch("http://localhost:3001/api/enrollcourse", {
      method: "POST",
      headers: {
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:3001/api/postdiplomacourse")
      .then((response) => response.json())
      .then((data) => {
    ...
    <div class="my-0" id="PostDiploma">
      <div class="p-5 text-center bg-body-tertiary">
        <div class="container py-5">
          ...
          <h1 class="text-body-emphasis">Post-Diploma Program Registration</h1>
          ...
          <Link to="/StudentPostDiploma" className="btn btn-primary btn-md ms-2">
            My Course
          </Link>

          <Link to="/StudentPostDiplomaRegister" className="btn btn-danger btn-md ms-2">
            Register Course
          </Link>
                            ...
                            <tr key={postdiplomacourselist.CourseID}>
                              ...
                              <td>
                                <Link
                                  ...
                                  onClick={() =>
                                    enrollCourse(postdiplomacourselist.CourseID)
                                  }
                                >
                                  ENROLL
                                </Link>
...
export default StudentPostDiplomaRegister;
